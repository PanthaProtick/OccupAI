...
it("shows the login form even when another session is active",()=>{render(<AuthContext.Provider value={{...auth,user:{id:"1",name:"Student",email:"student@aust.edu",role:"user"}}}><MemoryRouter><AuthPage/></MemoryRouter></AuthContext.Provider>);expect(screen.getByRole("heading",{name:"Continue to your campus"})).toBeInTheDocument()});
