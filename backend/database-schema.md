...
boolean in-app/high-occupancy switches, a constrained 45–100 threshold, a positive cooldown,
and UTC creation/update timestamps. Missing rows use and persist defaults of enabled, 45%,
and 30 minutes.
