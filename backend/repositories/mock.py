...
class MockOccupancyRepository:
    ...
    def __init__(self, fixture_dir: Path) -> None:
        ...
        try:
            ...
            self.generated_at = datetime.fromisoformat(rooms_payload["generated_at"].replace("Z", "+00:00"))
        ...
        try:
            ...
            self.history_generated_at = datetime.fromisoformat(
                history_payload["generated_at"].replace("Z", "+00:00")
            )
